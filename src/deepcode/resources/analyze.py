...
class AnalyzeResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> AnalyzeResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/deepcode-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> AnalyzeResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/deepcode-python#with_streaming_response
        """
